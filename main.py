...
# =============== CONFIGURATION ===============
BOT_TOKEN = "8973150442:AAHZi7Ax_3e0az4j4G6Moh_LWmvlbDh56G0"   # APNA COMPLETE TOKEN YAHAN
GROUP_IDS = [-1003743145694]        # APNE GROUP IDS

API_URLS = [
    "http://number-panel-production.up.railway.app/api/Junaidn?type=sms",
    "http://number-panel-production.up.railway.app/api/Junaid?type=sms",
    "http://number-panel-production.up.railway.app/api/psjunaid?type=sms",
    "https://mis-panel.onrender.com/api/fjunaid?type=sms",
    "https://mis-panel.onrender.com/api/junaid?type=sms",
]
...
Powered by Hridoykhan
"""

async def send_to_telegram(text):
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("📢 Channel", url="https://t.me/GAMING_BYPASS_INTERNET4"),
         InlineKeyboardButton("👨‍💻 Dev", url="https://t.me/numberpannell")]
    ])
